...
export const services = [
    ...
    },
    {
        ...
        description: 'Un outil sur-mesure accessible depuis internet. Gestion de clients, réservations, etc.',
        features: ['Simple à utiliser', 'Sauvegarde de vos données', 'Accès sécurisé'],
        featured: true
    },
    {
        icon: '📱',
        title: 'Application Mobile',
        description: 'Une application pour téléphone iPhone et Android.',
        features: ['iPhone & Android', 'Alertes sur téléphone', 'Disponible sur les stores']
    }
];
...
export const processSteps = [
    {
        title: 'Consultation',
        description: "Nous échangeons sur votre projet. Vous m'expliquez votre vision et vos objectifs."
    },
    {
        title: 'Design Gratuit',
        description: 'Je crée la maquette gratuitement. Vous validez avant tout engagement.'
    },
    {
        title: 'Acompte & Développement',
        description: "50% d'acompte pour lancer le projet. Je développe votre site."
    },
    {
        title: 'Livraison & Solde',
        description: 'Mise en ligne, formation et support. Solde par virement à la livraison.'
    }
];
...
export const reasons = [
    {
        ...
        description:
            "Vous n'avez rien à faire. Je gère toute la partie technique pour vous. Vous me donnez vos idées, je les transforme en site."
    },
    {
        icon: '✨',
        title: 'Un résultat de qualité',
        description:
            'Un site moderne et professionnel qui donne confiance à vos clients. Beau sur téléphone comme sur ordinateur.'
    },
    {
        icon: '⚡',
...
export const pricingFeatures = [
    'Je crée un aperçu gratuit avant de payer',
    'Un design moderne fait pour vous',
    'Fonctionne sur téléphone et tablette',
    "J'ajoute vos textes et photos",
    'Votre adresse internet incluse (1 an)',
    'Je reste disponible 7j/7 après',
    'Je vous apprends à modifier votre site'
];
...
export const portfolio = [
    ...
    },
    {
        ...
        width: 1024,
        height: 590,
        alt: 'My Prestige - Conciergerie de luxe',
        tag: 'Prestige',
        title: 'My Prestige',
        description: 'Site pour une conciergerie de luxe',
    ...
    },
    {
        ...
        width: 1024,
        height: 590,
        alt: 'Loumrhari Agency - Site portfolio',
        tag: 'Portfolio',
        title: 'Loumrhari Agency',
        description: 'Portfolio personnel moderne',
        tech: ['Portfolio', 'SEO', 'Premium']
    }
];
...
export const blogPosts = [
    ...
    },
    {
        ...
        tag: 'Business',
        gradient: 'linear-gradient(135deg, #FF6B9D 0%, #FFB366 100%)',
        date: '16 Décembre 2025',
        readTime: '5 min',
        title: 'Pourquoi avoir un site web en 2025 est essentiel',
        excerpt:
            'Découvrez pourquoi une présence en ligne professionnelle est devenue indispensable pour tout entrepreneur...',
        description:
    ...
    },
    {
        ...
        tag: 'Tech',
        gradient: 'linear-gradient(135deg, #6B7DFF 0%, #00D4AA 100%)',
        date: '14 Décembre 2025',
        readTime: '7 min',
        title: 'Application web vs site vitrine : que choisir ?',
        excerpt: 'Comprenez les différences clés pour faire le bon choix selon vos besoins et votre budget...',
        description:
    ...
    },
    {
        ...
        tag: 'Conseils',
        gradient: 'linear-gradient(135deg, #00D4AA 0%, #6B7DFF 100%)',
